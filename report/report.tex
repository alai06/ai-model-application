...
\begin{titlepage}
    ...
    \begin{flushleft}
        ...
        \captionof{figure}{University Logo} % Add this line
    \end{flushleft}
\end{titlepage}
...
\noindent\rule{\textwidth}{1pt} % Add this line
...
\begin{figure}[h]
    ...
    \caption{LSTM Model Architecture} % Add this line
    \label{fig:model}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/Capture d\'\e9cran 2025-01-05 200052.png}
    \caption{Data Preparation Process} % Add this line
...
\begin{figure}[h]
    ...
    \caption{Model Evaluation} % Add this line
    \label{fig:evaluation}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{img/Capture d\'\e9cran 2025-01-05 201711.png}
    \caption{Training Process} % Add this line
    \label{fig:training}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Real vs. Predicted Bitcoin Prices} % Add this line
...
\begin{figure}[h]
    ...
    \caption{Comparison of MSE and R\textsuperscript{2} Metrics} % Add this line
    \label{fig:metrics}
\end{figure}
